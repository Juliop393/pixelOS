        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20 lg:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#2A2826]/60 backdrop-blur-sm border border-[#3A3833]/50 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#E8E6E1] mb-3">Describe tu producto</h3>
              <p className="text-[#9A9893] leading-relaxed">
                Ingresa qué estás vendiendo en una línea. Sin briefs largos, sin reuniones.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#E8E6E1] mb-3">Elige tu estrategia</h3>
              <p className="text-[#9A9893] leading-relaxed">
                Selecciona el ángulo de venta, estilo visual y formato. La IA hace el resto.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#E8E6E1] mb-3">Descarga y publica</h3>
              <p className="text-[#9A9893] leading-relaxed">
                Tu creativo listo para Meta Ads en segundos. Sin diseñadores, sin esperas.
              </p>
            </div>
          </div>
        </div>
